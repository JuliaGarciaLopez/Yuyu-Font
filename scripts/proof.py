...
M = 36   # Margin
U = 18   # Unit
ROMAN_FONT = "fonts/ttf/Yuyu-Regular.ttf"
ITALIC_FONT = "fonts/ttf/YuyuShort-Regular.ttf"
WGHT = 400
WDTH = 100
...
nnnnnnnnnnn oooooooooo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnonnoonoo nnannooaoo nnbnnooboo nncnnoocoo nndnnoodoo nnennooeoo nnfnnoofoo nngnnoogoo nnhnnoohoo nninnooioo nnjnnoojoo nnknnookoo nnlnnooloo nnmnnoomoo nnpnnoopoo nnqnnooqoo nnnnooroo nnsnnoosoo nntnnootoo nnunnoouoo nnvnnoovoo nnwnnoowoo nnxnnooxoo nnynnooyoo nnznnoozoo
'''
...
008088088 0010088188 0020088288 0030088388 0040088488 0050088588 0060088688 0070088788 0090088988 234-345-6578 206-553-9876
'''
...
# DRAW TEXT BLOCKS WITHOUT textBox()
def draw_text_block(text_string, box, font_size, line_height=None, wrap_ratio=0.6):
    x, y, width, height = box
    if line_height is None:
        line_height = font_size * 1.4
    wrap_width = max(20, int(width / (font_size * wrap_ratio)))
    lines = []
...
parser.add_argument("--output", help="Save proof image to this file")
...
text("Yuyu Mid font proof", (M, (U*27)+3))
# MAIN TEXT #-----------------#
font(ROMAN_FONT)
fontSize(14)
lineHeight(14*1.4)
draw_text_block(SPACING_STRINGS_LETTERS_LOWERCASE+
        SPACING_STRINGS_LETTERS_UPPERCASE+
        SPACING_STRINGS_LETTERS_LOWERCASE_PUNCTUATION+
        SPACING_STRINGS_LETTERS_UPPERCASE_PUNCTUATION,
        (M+(U*10), M, U*30, U*29), 14)
...
fill(0)
text("14pt Spacing Strings", (M, (U*29)+3))
text("Yuyu Short font proof", (M, (U*27)+3))
# MAIN TEXT #-----------------#
font(ITALIC_FONT)
fontSize(14)
lineHeight(14*1.4)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(SPACING_STRINGS_NUMBERS_BASIC+
        SPACING_STRINGS_NUMBERS_PI+
        SPACING_STRINGS_NUMBERS_EXTRA,
        (M+(U*10), M, U*30, U*29), 14)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(KERN_KING_LOWERCASE*2, (M+(U*10), M, U*30, U*29), 14)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(KERN_KING_UPPERCASE, (M+(U*10), M, U*30, U*29), 14)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(KERN_KING_SENTENCECASE*2, (M+(U*10), M, U*30, U*29), 14)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(ADVENTURES_IN_WONDERLAND*2, (M+(U*10), M, U*19, U*29), 14)
...
fontSize(14)
lineHeight(14*1.4)
draw_text_block(RADIO_CANADA*3, (M+(U*10), M, U*19, U*29), 14)
